          ...
          <div class="card content-area p-4">
            <div class="col-md-12">
              <div class="btn-group float-right" role="group">              
                ...
                <button id="seller_model" type="button" class="btn btn-warning" autofocus="autofocus" title="Commission on sale & Purchase" data-target='#set_commission_model' data-toggle="modal"> > Commission on Sales & Purchase</a></button>
              </div>
            </div>           
