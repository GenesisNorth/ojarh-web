            ...
            <aside class="sidebar">
                <div id="leftside-navigation" class="nano">
                    <ul class="nano-content">
                        ...
                        <li><a href="<?= base_url('http://localhost/codeserver/admin/home') ?>"><i class="fa-solid fa-user"></i> <span><?= !empty($this->lang->line('admin')) ? $this->lang->line('admin') : 'admin' ?></span></a></li>
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="topbar-right text-lg-right">
                        <ul class="list-inline">
                            ...
                            <li><a href="<?= base_url('/admin/login') ?>" class="hide-sec"><?= !empty($this->lang->line('admin')) ? $this->lang->line('admin') : 'Admin Login' ?></a></li>
